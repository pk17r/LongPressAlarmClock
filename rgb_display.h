...
// PRIVATE CONSTANTS
  ...
  const char slowStr[5] = "SLOW", medStr[7] = "MEDIUM", fastStr[5] = "FAST", runScreensaverStr[4] = "RUN", flyScreensaverStr[4] = "FLY", bounceScreensaverStr[7] = "BOUNCE";
  ...
  const int16_t kScreensaverMotionButtonW = 140, kScreensaverMotionButtonX1 = kTftWidth - kRunScreensaverButtonW - kScreensaverMotionButtonW - 15, kScreensaverMotionButtonY1 = 140, kScreensaverMotionButtonH = 25;
  const int16_t kScreensaverSpeedButtonW = 140, kScreensaverSpeedButtonX1 = kTftWidth - kRunScreensaverButtonW - kScreensaverSpeedButtonW - 15, kScreensaverSpeedButtonY1 = 170, kScreensaverSpeedButtonH = 25;
